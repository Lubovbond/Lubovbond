  ...
  <thead>
    ...
    <tr>
      <td>
        ...
        <br><small><i>Учебный проект (Karpov.Courses).</i> Написание продвинутых аналитических SQL-запросов, проектирование реляционных связей, агрегация данных, применение оконных функций и когортный анализ пользователей для симуляции реальных продуктовых задач.</small>
      </td>
